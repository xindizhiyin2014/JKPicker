#
# Be sure to run `pod lib lint JKPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'JKPicker'
  s.version          = '0.1.0'
  s.summary          = 'this is a tool of datePicker,picker,it will update with needs'
...
this is a tool of datePicker,picker,it will update with needs.welcome to join us
  ...
  s.source_files = 'JKPicker/Classes/**/*'
  
  # s.resource_bundles = {
  #   'JKPicker' => ['JKPicker/Assets/*.png']
  # }
